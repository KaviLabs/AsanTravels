...
if (isset($_POST["submit2"])) {
    ...
    if (empty($start_date) || empty($end_date) || $passengerInput < 1 || empty($name) || empty($email)) {
        ...
        $extras = 0.0;
        $optionalNames = [];
        if (!empty($optionalTours) && is_array($optionalTours)) {
            foreach ($optionalTours as $tourId) {
...
<body>
        ...
        <div class="container"><br>
            <div class="section"><br>
                ...
                <select id="tripDays" disabled style="background-color: #e9ecef; cursor: not-allowed;">
                    <option value="13" selected>13 Day(s)</option>
                </select>
                <input type="hidden" name="tripDays" value="13">
    ...
    <script>
        ...
        const STORAGE_KEY = 'asan_booking_heritage_escape';
